export const TaskList = (props) => {
  ...
  return (
        <li className="flex flex-row mb-1 mr-2">
          <div className="grid grid-cols-4 justify-between p-2 max-w-2xl w-full transition duration-500 shadow border-4 border-white hover:border-4 hover:border-green-500 ease-in-out transform hover:-translate-y-1 hover:shadow-lg select-none cursor-pointer bg-white dark:bg-gray-800 rounded-md ">
